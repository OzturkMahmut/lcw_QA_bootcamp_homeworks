...
public class Main {
    public static void main(String[] args) {
        ...
        /*
        expected logs:
            Case 1 Email Error: Lütfen geçerli bir e-posta adresi giriniz.
            Case 2 Password Error: Lütfen şifrenizi giriniz.
            Case 3 Password Error 2: Şifreniz harf ile rakam içermeli ve en az altı karakter olmalıdır.
         */
